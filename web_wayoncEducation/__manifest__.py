...
#
#    wayoncEducation
#    Copyright (C) 2009-TODAY wayoncEducation(<https://wayonc.in>).
#
...

{
    ...
    'images': [
        'static/description/web_wayoncEducation_banner.jpg',
    ],
    'depends': [
        'website',
    ],
    ...
    'assets': {
        'web.assets_frontend': [
            '/web_wayoncEducation/static/src/scss/homepage.scss',
        ],
        'web._assets_primary_variables': [
            '/web_wayoncEducation/static/src/scss/primary_variables.scss'
        ],
    }
}
